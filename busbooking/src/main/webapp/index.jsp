...
body {
    ...
    margin: 0;
    padding: 0;
    background: url("https://st.redbus.in/Images/India/ContextualLogin/generic_banner_Ind.png") no-repeat center center fixed;
...
<body>
    ...
    <div class="container popular-routes">
        ...
        <div class="route-card">
            <span> Vijayawada -------------- Chennai</span>
            <a href="search.jsp?source=Chennai&destination=Kolkata" class="btn">Find Buses</a>
        </div>
        <div class="route-card">
            <span> Vijayawada -------------- Kolkata</span>
            <a href="search.jsp?source=Chennai&destination=Kolkata" class="btn">Find Buses</a>
        </div>
        <div class="route-card">
            <span> Vijayawada -------------- Bangalore</span>
            <a href="search.jsp?source=Chennai&destination=Kolkata" class="btn">Find Buses</a>
        </div>
